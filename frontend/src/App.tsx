  ...
  return (
    <div className="root">
      ...
      <div className="buttons">
        ...
        <button onClick={() => sendRequest('RESTART')}>Restart</button>
        <button onClick={() => sendRequest('RESET')}>Reset</button>
        <br />
        <br />
        <button className="red" onClick={() => sendRequest('RED')}>
          Red
        </button>
        <button className="green" onClick={() => sendRequest('GREEN')}>
          Green
        </button>
        <button className="yellow" onClick={() => sendRequest('YELLOW')}>
          Yellow
        </button>
        <button
          className="yellow"
